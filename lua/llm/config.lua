...
M.configs = {
    ...
    keys = {
        ...
        ["Input:Submit-n"] = { mode = "n", key = "<cr>" },
        ["Input:Submit-i"] = { mode = "i", key = "<C-s>" },
        ["Input:Cancel"] = { mode = "n", key = "<C-c>" },
        ["Input:Resend"] = { mode = "n", key = "<C-r>" },

        -- only works when "save_session = true"
        ["Input:HistoryNext-n"] = { mode = "n", key = "<C-j>" },
        ["Input:HistoryPrev-n"] = { mode = "n", key = "<C-k>" },
        ["Input:HistoryNext-i"] = { mode = "i", key = "<C-j>" },
        ["Input:HistoryPrev-i"] = { mode = "i", key = "<C-k>" },
